...
from .models import Agegroup, Banners, Card, CardBanner1, CardBanner2, CardBanner3, Committee, Event, Form, Prayer, Video, duaandspecialrequests, feedbackandquestions, subscribeandnewsletter   
...
class EventSerializer(serializers.ModelSerializer):
    class Meta:
        model = Event
        fields = ['id', 'image', 'date','event_name',
