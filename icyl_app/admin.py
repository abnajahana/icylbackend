...
from icyl_app.models import Agegroup,Banners, Card, CardBanner1, CardBanner2, CardBanner3,Committee,Event,Form,Prayer,Video,Index
...
class FormAdmin(admin.ModelAdmin):
    list_display = ('id','image' ,'prayer_name','iqamat_time','namas_time')
